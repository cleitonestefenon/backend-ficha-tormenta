package com.github.cleitonestefenon.fichatormentaapi.infrastructure.exception;
...
public class PessoaExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handlePessoaNotFoundException(EntityNotFoundException exception) {
    ...
    public ResponseEntity<Object> handlePessoaExistsException(EntityExistsException exception) {
        return buildResponseEntity(
    ...
    protected  ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        return buildResponseEntity(HttpStatus.BAD_REQUEST, "Erro Encontrado", errors);
    }
